...
const Navbar = ({ cartCount, onCartToggle }) => {
  ...
  return (
    ...
    >
      ...
      {/* MOBILE MENU OVERLAY */}
      <div
        className={`fixed inset-0 h-screen w-screen z-[105] bg-black/95 backdrop-blur-[40px] transition-all duration-500 flex flex-col items-center justify-center md:hidden ${
      ...
      >
        <div className="flex flex-col items-center justify-center space-y-10 w-full">
          ...
          <div
            className={`flex gap-10 pt-10 transition-all duration-700 delay-300 ${
              isMenuOpen
          ...
          >
            <a
              href="#"
              className="text-2xl text-white/50 hover:text-purple-500 transition-colors"
            >
